export default {
	...
	menu: [
...

		{
			...
			menuId: '3',
			sub: [
				{title: '用户管理', component: 'views/user_mgmt/user/index', menuId: '3-1'},
				{title: '角色管理', component: 'hello2', menuId: '3-2'},
				{title: '权限管理', component: 'hello3', menuId: '3-3'}
			]
		},
